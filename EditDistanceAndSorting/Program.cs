...
namespace Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (s1 == "-1" && s2 == "-1")
            {
                Console.WriteLine("Exiting program as user enters -1, -1");
                Console.ReadKey();
                return;
            }

            int m = Align(s2, s1, 1, 1, 1, null, null);
        }

        private static int Align(string s1, string s2, int subCost = 1, int delCost = 1, int insCost = 1, string alignment1 = null, string alignment2 = null)
        {
